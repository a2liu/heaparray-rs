...
impl<'a, E, L> Container for TpRcArray<'a, E, L> {
    fn len(&self) -> usize {
        self.0.len()
    }
}

impl<'a, E, L> CopyMap<usize, E> for TpRcArray<'a, E, L> {
...
impl<'a, E, L> LabelledArray<E, L> for TpRcArray<'a, E, L> {
...
impl<'a, E, L> LabelledArrayRefMut<E, L> for TpRcArray<'a, E, L> {
    fn get_label_mut(&mut self) -> Option<&mut L> {
        self.0.get_label_mut()
    }
}

impl<'a, E> MakeArray<E> for TpRcArray<'a, E, ()>
where
    E: 'a,
{
...
impl<'a, E, L> DefaultLabelledArray<E, L> for TpRcArray<'a, E, L>
where
    E: Default,
{
