...
impl<'a, E, L> BaseArrayRef for RcArray<'a, E, L> {
    fn is_null(&self) -> bool {
        self.0.is_null()
    }
}
impl<'a, E, L> Clone for RcArray<'a, E, L> {
    fn clone(&self) -> Self {
        Self(self.0.clone())
    }
}
...
impl<'a, E, L> CopyMap<'a, usize, E> for RcArray<'a, E, L> {
...
impl<'a, E, L> Array<'a, E> for RcArray<'a, E, L> {}

impl<'a, E, L> LabelledArray<'a, E, L> for RcArray<'a, E, L> {
...
impl<'a, E> MakeArray<'a, E> for RcArray<'a, E, ()>
where
    E: 'a,
{
...
impl<'a, E, L> DefaultLabelledArray<'a, E, L> for RcArray<'a, E, L>
where
    E: Default,
{
...
unsafe impl<'a, E, L> Send for RcArray<'a, E, L> where Inner<'a, E, L>: Send {}
unsafe impl<'a, E, L> Sync for RcArray<'a, E, L> where Inner<'a, E, L>: Sync {}
